    ...
    socketNotificationReceived: function(notification, payload) {
        ...
        if (notification === "OPENMETEO_FORECAST_GET") {
            ...
            var apiUrl = `https://api.open-meteo.com/v1/forecast?` +
                ...
                `&daily=temperature_2m_max,temperature_2m_min,weathercode,windspeed_10m_max,winddirection_10m_dominant,windgusts_10m_max,precipitation_probability_max,precipitation_sum,sunrise,sunset` +
                `&timeformat=unixtime` +
                `&timezone=auto` +
